...
class Personaje(pygame.sprite.Sprite):
    ...
    def update(self):
        ...
        #Tools.Logger.escribir(self.statusText() +  " imagen de animaci�n: " + str(self.currentAnimFrame) + ", y el frame de tiempo " + str(self.framecount))
    ...
    def statusText(self):
        return("jugador: " + str(self.player) + ", en estado " + self.currentAnim + ", en posici�n " + str(self.pos) + " y rect: " + str(self.rect)+"\n")
